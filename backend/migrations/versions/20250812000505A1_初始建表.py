...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('visitor', 'user', 'admin', name='roleenum'), nullable=False),
    ...
    sa.Column('visibility', sa.Enum('public', 'private', 'password', name='articlevisibility'), nullable=False),
