...
[功能特性](#-功能特性) • [快速开始](#-快速开始) • [技术架构](#-技术架构) • [开发工具](#-开发工具) • [部署指南](#-部署指南) • [贡献指南](#-贡献指南) • [安全政策](#️-安全政策) • [API文档](#-api文档)
...
⚠️ **重要提醒**: 本项目采用专有许可证，代码贡献需要签署 [贡献者许可协议](./CONTRIBUTOR_LICENSE_AGREEMENT.md)
...
> 💡 **为什么需要CLA？** 由于采用专有许可证，需要明确代码版权归属，确保项目的法律合规性。
...
### 🤝 贡献须知
如需贡献代码，请查看 [贡献者许可协议](./CONTRIBUTOR_LICENSE_AGREEMENT.md)。

### 📞 商业授权
如需商业使用授权，请联系：`contact@luminarc.tech`
