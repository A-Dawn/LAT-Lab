...
本次更新对文章点赞功能进行了全面重构，解决了点赞计数问题，实现了用户点赞状态的正确跟踪和显示，同时优化了页面内容的对齐方式，提升阅读体验，具体详见

[v0.2.5_DevOps.md]: https://github.com/A-Dawn/LAT-Lab/blob/main/Docs/v0.2.5_DevOps.md	"0.2.5更新"
...
### v0.2.5 (2025-07-28)
- 【功能重构】重构文章点赞系统，实现了准确的点赞计数
- 【数据结构】新增文章-用户点赞关联表，防止重复点赞
- 【API优化】添加点赞状态查询和切换API，支持点赞/取消点赞
- 【前端优化】改进点赞按钮交互体验，点赞状态可视化
- 【页面优化】优化文章内容区域文本对齐方式，统一采用左对齐提升阅读体验
- 【样式改进】添加了全局和主题特定的CSS规则，确保内容一致性
- 【组件封装】创建了内容样式工具，提供可复用的左对齐指令
- 【数据库迁移】添加article_likes表，存储点赞记录
- 【修复Bug】解决前端点赞按钮不能取消点赞的问题
- 【修复Bug】解决刷新页面后点赞状态丢失的问题
- 【修复Bug】解决点赞数与实际不符的计数问题
